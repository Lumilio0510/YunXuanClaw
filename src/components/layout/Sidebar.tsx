...
import logoSvg from '@/assets/善能透明背景logo.png';
...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { to: '/database', icon: <Database className="h-[18px] w-[18px]" strokeWidth={2} />, label: t('sidebar.database'), testId: 'sidebar-nav-database' },
