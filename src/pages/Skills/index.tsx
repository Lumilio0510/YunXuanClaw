      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-8 py-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-[28px] font-sans text-foreground font-normal mb-3 text-center tracking-tight">
              {skill.name}
            </h2>
            <div className="flex items-center justify-center gap-2.5 mb-6 opacity-80">
              <Badge variant="secondary" className="font-sans text-[11px] font-medium px-3 py-0.5 rounded-full bg-black/[0.04] dark:bg-white/[0.08] hover:bg-black/[0.08] dark:hover:bg-white/[0.12] border-0 shadow-none text-foreground/70 transition-colors">
                v{skill.version}
              </Badge>
              <Badge variant="secondary" className="font-sans text-[11px] font-medium px-3 py-0.5 rounded-full bg-black/[0.04] dark:bg-white/[0.08] hover:bg-black/[0.08] dark:hover:bg-white/[0.12] border-0 shadow-none text-foreground/70 transition-colors">
          ...
          <div className="space-y-7 px-1">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <Badge variant="secondary" className="font-sans text-[11px] font-medium px-3 py-0.5 rounded-full bg-black/[0.04] dark:bg-white/[0.08] border-0 shadow-none text-foreground/70">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  readOnly
                  className="h-[38px] font-sans text-[12px] bg-[#eeece3] dark:bg-muted border-black/10 dark:border-white/10 rounded-xl text-foreground/70"
                />
                <Button
                  variant="outline"
                  size="icon"
            ...
            {!skill.isCore && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="password"
                  className="h-[44px] font-sans text-[13px] bg-[#eeece3] dark:bg-muted border-black/10 dark:border-white/10 rounded-xl focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:border-blue-500 shadow-sm transition-all text-foreground placeholder:text-foreground/40"
                />
                  ...
                  {envVars.map((env, index) => (
                    <div className="flex items-center gap-3" key={index}>
                      <Input
                        ...
                        className="flex-1 h-[40px] font-sans text-[13px] bg-[#eeece3] dark:bg-muted border-black/10 dark:border-white/10 rounded-xl focus-visible:ring-2 focus-visible:ring-blue-500/50 shadow-sm text-foreground"
...
export function Skills() {
  ...
  const [skillsDirPath, setSkillsDirPath] = useState('~/.yuanxuanclaw/skills');
                    ...
                    <div className="flex flex-col overflow-hidden">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {skill.slug && skill.slug !== skill.name ? (
                          <span className="text-[11px] font-sans px-1.5 py-0.5 rounded border border-black/10 dark:border-white/10 text-muted-foreground">
                            {skill.slug}
                          </span>
                        ) : null}
                      </div>
      ...
      <Sheet open={installSheetOpen} onOpenChange={setInstallSheetOpen}>
        ...
        >
          <div className="px-7 py-6 border-b border-black/10 dark:border-white/10">
            <h2 className="text-[24px] font-sans text-foreground font-normal tracking-tight">{t('marketplace.installDialogTitle')}</h2>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 shrink-0" onClick={e => e.stopPropagation()}>
                        {skill.version && (
                          <span className="text-[13px] font-sans text-muted-foreground mr-2">
                            v{skill.version}
                          </span>
                        )}
                        {isInstalled ? (
