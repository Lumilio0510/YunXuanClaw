...
export function Settings() {
  ...
  const handleOpenOpenClawUi = async () => {
    try {
      const result = await hostApiFetch<{
        success: boolean;
        url?: string;
      ...
      if (result.success && result.url) {
        ...
        toast.error(result.error || t('gateway.openUiFailed'));
      }
    } catch (error) {
      toast.error(`${t('gateway.openUiFailed')}: ${toUserMessage(error)}`);
    }
  };
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={handleOpenOpenClawUi} className="rounded-full h-8 px-4 border-black/10 dark:border-white/10 bg-transparent hover:bg-black/5 dark:hover:bg-white/5">
              ...
              {showLogs && (
                <div className="p-4 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5">
                  ...
                  <pre className="text-[12px] text-muted-foreground bg-white dark:bg-card p-4 rounded-xl max-h-60 overflow-auto whitespace-pre-wrap font-sans border border-black/5 dark:border-white/5 shadow-inner">
          ...
          {devModeUnlocked && (
            <>
              ...
              <div data-testid="settings-developer-section">
                <h2 data-testid="settings-developer-title" className="text-3xl font-sans text-foreground mb-6 font-normal tracking-tight">
                  {t('developer.title')}
                </h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              className="h-10 rounded-xl bg-black/5 dark:bg-white/5 border-transparent font-sans text-[13px]"
                            />
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Input
                        ...
                        className="font-sans text-[13px] h-10 rounded-xl bg-black/5 dark:bg-white/5 border-transparent flex-1 min-w-[200px]"
                      />
                      <Button
                        type="button"
                        variant="outline"
                  ...
                  <div className="space-y-4">
                    ...
                    {doctorResult && (
                      <div className="space-y-3 rounded-2xl border border-black/10 dark:border-white/10 p-5 bg-black/5 dark:bg-white/5">
                        ...
                        <div className="space-y-1 text-[12px] text-muted-foreground font-sans break-all">
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                          <div className="space-y-2">
                            ...
                            <pre className="max-h-72 overflow-auto rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-card p-3 text-[11px] font-sans whitespace-pre-wrap break-words">
                    ...
                    {showTelemetryViewer && (
                      <div className="space-y-4 rounded-2xl border border-black/10 dark:border-white/10 p-5 bg-black/5 dark:bg-white/5">
                        ...
                        <div className="max-h-80 overflow-auto rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-card shadow-inner">
                          ...
                          <div className="space-y-2 p-3 font-sans text-[12px]">
