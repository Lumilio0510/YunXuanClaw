...
import zhDatabase from './locales/zh/database.json';
...
import jaDatabase from './locales/ja/database.json';
...
import ruDatabase from './locales/ru/database.json';
...
i18n
    ...
    .init({
        ...
        defaultNS: 'common',
        ns: ['common', 'settings', 'dashboard', 'chat', 'channels', 'agents', 'skills', 'cron', 'setup', 'database'],
        interpolation: {
