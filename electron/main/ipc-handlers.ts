 ...
 * Direct read/write to ~/.yuanxuanclaw/openclaw.json (bypasses Gateway RPC)
 */
...
function registerOpenClawHandlers(gatewayManager: GatewayManager): void {
  ...
  // Get the OpenClaw config directory (~/.yuanxuanclaw)
  ipcMain.handle('openclaw:getConfigDir', () => {
    return getOpenClawConfigDir();
  });

  // Get the OpenClaw skills directory (~/.yuanxuanclaw/skills)
